...
handelanimation = () => {
  Animated.sequence([
    Animated.timing(this.state.animation, { duration: 200, toValue: 1,useNativeDriver: true}),
    Animated.spring(this.state.animation, { toValue: 1, friction: 2,useNativeDriver: true})
  ]).start()
